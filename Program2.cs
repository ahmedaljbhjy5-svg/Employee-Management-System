...
namespace ipg203
{
    ...
    public abstract class Employee : IEmployeeActions
    {
        ...
        // FIX: CheckSalary now only fires the event, does NOT add to TotalSalaryBudget
        ...
        // FIX: New static method to calculate total budget once (avoids accumulation bug)
    ...
    public class Developer : Employee
    {
        ...
        // FIX: Removed the redundant hoursWorked * hourlyRate from base() call.
    ...
    public static class DataValidator
    {
        ...
        // FIX: IsValidHours is now used inside Developer.HoursWorked setter
